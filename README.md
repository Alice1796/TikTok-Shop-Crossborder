...
| 模块 | 说明 | 图片占位 |
|------|------|----------|
| 登录/注册 | 多语言登录与邀请码注册 | 可放置 `docs/readme-images/screen-login.png` |
| 首页 | 多语言首页、活动与公告 | 可放置 `docs/readme-images/screen-home.png` |
| 订单任务 | 订单列表与提交任务 | 可放置 `docs/readme-images/screen-order.png` |
